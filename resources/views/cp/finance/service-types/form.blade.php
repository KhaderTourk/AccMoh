...
@section('content')
<form method="post" action="{{ $type->exists ? route('cp.service-types.update', $type) : route('cp.service-types.store') }}" class="max-w-xl rounded-2xl border bg-white dark:bg-slate-800 p-6 space-y-4">
    @csrf
