            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 overflow-y-auto py-4 px-3">
                    <ul class="space-y-0.5">
                        ...
                        <li class="cp-nav-section pt-2 mt-2 {{ request()->routeIs('cp.clients.*', 'cp.client-services.*', 'cp.payments.*', 'cp.service-types.*', 'cp.workers.*', 'cp.suppliers.*') || (request()->routeIs('cp.expense-categories.*') && request()->route('scope') === 'work') ? '' : 'cp-collapsed' }}" data-section="business">
                            <button type="button" class="cp-section-toggle" aria-expanded="{{ request()->routeIs('cp.clients.*', 'cp.client-services.*', 'cp.payments.*', 'cp.service-types.*', 'cp.workers.*', 'cp.suppliers.*') || (request()->routeIs('cp.expense-categories.*') && request()->route('scope') === 'work') ? 'true' : 'false' }}">
                                <span>العمل</span>
                            ...
                            <ul class="cp-section-content space-y-0.5">
                                ...
                                <li><a href="{{ route('cp.workers.index') }}" class="cp-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('cp.workers.*') ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}"><span class="material-symbols-outlined text-xl">engineering</span><span>العمال</span></a></li>
                                <li><a href="{{ route('cp.suppliers.index') }}" class="cp-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('cp.suppliers.*') ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}"><span class="material-symbols-outlined text-xl">local_shipping</span><span>الموردون</span></a></li>
                                ...
                                <li><a href="{{ route('cp.expense-categories.index', 'work') }}" class="cp-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('cp.expense-categories.*') && request()->route('scope') === 'work' ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}"><span class="material-symbols-outlined text-xl">sell</span><span>تصنيفات مصروفات العمل</span></a></li>
                            </ul>
                        </li>
                        @endif
                        <li class="cp-nav-section pt-2 mt-2 {{ request()->routeIs('cp.family-members.*', 'cp.family-loans.*') ? '' : 'cp-collapsed' }}" data-section="family">
                            ...
                            <ul class="cp-section-content space-y-0.5">
                                ...
                                <li><a href="{{ route('cp.family-loans.debtors') }}" class="cp-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('cp.family-loans.debtors') || (request()->routeIs('cp.family-loans.create') && request('direction') === 'lent') ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}"><span class="material-symbols-outlined text-xl">handshake</span><span>مدين</span></a></li>
                                <li><a href="{{ route('cp.family-loans.creditors') }}" class="cp-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('cp.family-loans.creditors') || (request()->routeIs('cp.family-loans.create') && request('direction') === 'borrowed') ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}"><span class="material-symbols-outlined text-xl">replay</span><span>دائن</span></a></li>
                            </ul>
                        </li>
                        <li class="cp-nav-section pt-2 mt-2 {{ request()->routeIs('cp.expenses.*', 'cp.transfers.*', 'cp.ledger.*', 'cp.reports.*') || (request()->routeIs('cp.expense-categories.*') && request()->route('scope') === 'personal') ? '' : 'cp-collapsed' }}" data-section="ops">
                            <button type="button" class="cp-section-toggle" aria-expanded="{{ request()->routeIs('cp.expenses.*', 'cp.transfers.*', 'cp.ledger.*', 'cp.reports.*') || (request()->routeIs('cp.expense-categories.*') && request()->route('scope') === 'personal') ? 'true' : 'false' }}">
                            ...
                            <ul class="cp-section-content space-y-0.5">
                                ...
                                <li><a href="{{ route('cp.expense-categories.index', 'personal') }}" class="cp-nav-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('cp.expense-categories.*') && request()->route('scope') === 'personal' ? 'bg-primary/10 text-primary dark:bg-primary/20' : '' }}"><span class="material-symbols-outlined text-xl">label</span><span>تصنيفات المصروفات الشخصية</span></a></li>
